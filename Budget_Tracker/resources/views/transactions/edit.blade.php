...
@section('content')
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <a href="{{ route('transactions.index') }}" class="back-btn">← Back to Expenses</a>
        </div>
        ...
        <div class="edit-card">
            <form method="POST" action="{{ route('transactions.update', $transaction) }}" enctype="multipart/form-data">
                ...
                {{-- Type toggle removed — all transactions are expenses --}}
                ...
                <div class="btn-row">
                    <button type="submit" class="submit-btn">
                        <svg width="15" height="15" viewBox="0 0 24 24"
                            style="fill:none;stroke:currentColor;stroke-width:2.5;stroke-linecap:round">
                    ...
                    <button type="button" class="delete-btn" data-submit-form="delete-form">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
