    ...
    <main class="main-content">
        ...
        <div class="two-col">
            ...
            <div style="display:flex;flex-direction:column;gap:16px;">
                ...
                {{-- NEW: Rank Progress Panel --}}
                <div class="panel" style="padding:22px; border: 1px solid #FBCF97;">
                    ...
                    <div style="text-align: center;">
                        @if ($currentRank)
                            <img src="{{ asset($currentRank->image_path) }}" style="width:100px; height:100px; margin: 0 auto; filter: drop-shadow(0 0 8px rgba(251, 207, 151, 0.4));">
                            <p style="color: #FBCF97; font-weight: bold; margin-top: 10px; font-size: 1.1rem;">{{ $currentRank->title }}</p>
                            <div style="font-size: 11px; color: #bbb; text-transform: uppercase; letter-spacing: 1px;">Current Mastery Level</div>
                        @else
                            <p style="color: #bbb; font-size: 13px; padding: 20px 0;">No rank yet — keep saving!</p>
                        @endif
                    </div>
                </div>
