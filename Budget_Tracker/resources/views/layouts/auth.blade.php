...
<body class="bg-[#F9F7F2]">
    ...
    <header class="w-full px-6 md:px-12 py-6 md:py-8 flex items-center justify-between z-30">
        <div class="flex items-center gap-2 group cursor-default">
            ...
            <span class="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">MyBudget</span>
        </div>

        <div class="flex items-center gap-2 md:gap-4">
            <a href="{{ route('login') }}" class="btn-modern btn-outline text-xs md:text-sm">Sign in</a>
            <a href="{{ route('register') }}" class="btn-modern btn-primary text-xs md:text-sm">Sign up</a>
        </div>
    </header>
    ...
    <main class="auth-wrapper px-4">
        <div class="w-full max-w-[420px] bg-white border border-gray-200 shadow-xl p-6 md:p-10 z-20 rounded-2xl mb-10">
            @yield('content')
        </div>
    </main>
